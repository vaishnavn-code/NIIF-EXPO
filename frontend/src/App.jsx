...
const PDF_PAGES = [
  ...
  {
    key: "rates",
    title: "Interest Rate & Tenor Analysis",
    Component: Rates,
  },
  {
    key: "borrowers",
    title: "Borrower / Customer View",
    Component: Borrowers,
  },
  {
    key: "transactions",
...
export default function App() {
  ...
  const renderPage = () => {
    ...
    switch (page) {
      ...
      case "exposure":
        return <Exposure data={data} pdfMode />;
      case "loans":
    ...
    <div className="wrapper">
      ...
      <div className="main-area">
        <Header
          ...
          pdfData={data}
          pdfPages={PDF_PAGES}
          pdfFilePrefix="niif-exposure-full-report"
          pdfDisabled={loading || !!error || !data}
        />
